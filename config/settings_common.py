...
SECRET_KEY = 'django-insecure-6yo-_fg0eyfa)_6*g=ad28md3vwz1o+55mdc)g&l)6xzh_h4md'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'my_studyapp'),
        'USER': os.getenv('DB_USER', 'akinkat'),
...
ACCOUNT_EMIL_VERIFICATION = 'mandatory'
